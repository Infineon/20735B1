...
Overview
--------
The Cypress CYW20735 is an ultra-low-power dual-mode Bluetooth 5.0 wireless
MCU device. It has a stand-alone baseband processor with an integrated 2.4 GHz
transceiver supporting BR and BLE.

SDK Software Features
----------------------
- Dual mode Bluetooth stack included in the ROM (BR and BLE, no EDR).
- BT stack and profile level APIs for embedded BT application development.
- WICED HCI protocol to simplify host/MCU application development.
- APIs and drivers to access on board peripherals
- Bluetooth protocols include GAP, GATT, SMP, RFCOMM, SDP, BLE Mesh
...
----
CYW920735Q60EVB-01:
    60-QFN package, Arduino compatible headers, 9-axis motion sensor and
...
BT_DEVICE_ADDRESS
    ...
    for example 20735B10FFEE. By default, the SDK will set a BDA for your device
...
> make PLATFORM=CYW920735Q60EVB-01 OTA_FW_UPGRADE=1 build
